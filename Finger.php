...
<body>
    <div class="container">
        <div class="menu">
            ...
            <ul>
                <li class="active"><i class="fa-solid fa-droplet"></i><a style="color:black; text-decoration:none" href="\FINAL02\DHT11.php">Humd & Temp</a></li>
                <li><i class="fa-regular fa-user"></i><a style="color:black; text-decoration:none" href="">Finger List</a></li>
            </ul>
        </div>
        <div class="center">
            <h2>Finger List</h2>
            ...
            <table class="styled-table" id= "table_id">
                ...
                <tbody id="tbody_table_record">
                        ...
                        $sql = 'SELECT * FROM `esp32_table_finger_record` ORDER BY `esp32_table_finger_record`.`id` DESC    ';
                        foreach ($pdo->query($sql) as $row) {
                            ...
                            echo '<td class="bdr">'. $row['finger'] . '</td>';
